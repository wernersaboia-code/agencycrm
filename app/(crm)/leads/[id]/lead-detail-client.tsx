// app/(crm)/leads/[id]/lead-detail-client.tsx
                        ...
                        <CardContent className="space-y-3">
                            ...
                            {lead.mobile && (
                                <InfoRowWithCall
                                    ...
                                    label="Celular"
                                    value={lead.mobile}
                                    lead={{ ...leadForCall, phone: lead.mobile }}
                                />
                            )}
                            {lead.website && (
...
// 🆕 InfoRow com botão de ligar
interface InfoRowWithCallProps {
    icon: typeof Phone
    label: string
    value: string
    lead: {
...
function InfoRowWithCall({ icon: Icon, label, value, lead }: InfoRowWithCallProps) {
    return (
