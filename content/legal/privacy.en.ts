    ...
    sections: [
        {
            ...
            blocks: [
                { kind: "paragrafo", texto: "Easy Prospect is operated by Werner Wild Saboia Carvalho Marinho, an individual based in Fortaleza, Ceará, Brazil, who decides on the processing of the data described in this policy." },
